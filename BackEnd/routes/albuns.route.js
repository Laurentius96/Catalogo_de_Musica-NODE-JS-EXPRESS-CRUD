...
router.put("/edit/:id", albunsController.putAlbum); // 28°) [PUT] /albuns/edit/{id} = recebe um album e um id do Front-End e atualiza essa album na nossa lista...

router.delete("/delete/:id", albunsController.deleteAlbum); // 31°) [PUT] /albuns/delete/{id} = recebe um id e exclui o album que tiver esse id da lista...
