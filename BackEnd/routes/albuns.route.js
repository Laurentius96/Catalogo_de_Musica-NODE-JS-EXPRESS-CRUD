...
router.get("/", albunsController.getAlbuns); // 16°) [GET] /albuns = retorna uma lista de albuns de música...

router.get("/:id", albunsController.getAlbunsById); // 17°) [GET] /albuns/{id} = retorna um album de música de acordo com o seu ID...
